    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            if engine:
                ...
                LOGGER.info(f'Forcing batch=1 square inference (1,4,{imgsz},{imgsz}) for non-PyTorch models')  # 4ch
            ...
            model.eval()
            model.warmup(imgsz=(1 if pt else self.args.batch, 4, imgsz, imgsz))  # warmup  # 4ch
