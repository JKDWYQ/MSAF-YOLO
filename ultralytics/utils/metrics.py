...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):  # 使用CIoU # 计算loss
    """
...
def bbox_Inner_iou(box1,
                   box2,
                   alpha=1,
                   ratio=1,  # 1为iou [0.5,1.5]
                   xywh=True,
                   GIoU=False,
                   DIoU=False,
                   CIoU=False,
    ...
    Args:
        ...
        ratio: Inner-IoU对应的是尺度因子，通常取范围为[0.5，1.5],原文中VOC数据集对应的ratio设置在[0.7，0.8]之间有较大提升，数据集中大目标多则设置<1，小目标多设置>1
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or WIoU or MPDIoU:
        ...
        if CIoU or DIoU or EIoU or SIoU or WIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            return inner_iou - d1 / mpdiou_hw_pow - d2 / mpdiou_hw_pow - torch.pow((c_area - union) / c_area + eps, alpha)  # MPDIoU
        # c_area = cw * ch + eps  # convex area
        else:  # GIoU https://arxiv.org/pdf/1902.09630.pdf
            return inner_iou - torch.pow((c_area - union) / c_area + eps, alpha)
    return iou  # IoU
