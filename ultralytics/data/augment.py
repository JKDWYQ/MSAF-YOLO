...
class BaseMixTransform:
    """This implementation is from mmyolo.这个实现来自mmyolo。"""
...
class Mosaic(BaseMixTransform):
    ...
    def __init__(self, dataset, imgsz=640, p=1.0, n=4):
        """Initializes the object with a dataset, image size, probability, and border.使用数据集、图像大小、概率和边界初始化对象。"""
        assert 0 <= p <= 1.0, f'The probability should be in range [0, 1], but got {p}.'
        assert n in (4, 9), 'grid must be equal to 4 or 9.网格必须等于4或9。'
